...
<main class="ipl-page pt-5 pb-20 bg-[#F1F5F9] max-sm:pt-0">
    ...
    <div class="w-full bg-[#F1F5F9] px-2">
            ...
            <div class="p-4 grid grid-cols-4 gap-2 max-sm:grid-cols-2">
                ...
                for ($i = 0; $i < 10; $i++) {
                    ...
                    <div class="border border-[#D1D5DB] rounded-md overflow-hidden">
                        <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/img12.png" alt=""
                            loading="lazy" class="w-full object-cover" draggable="false">
    ...
    <section class="container px-0">
        <span class="max-sm:px-2 font-semibold text-[#141414]"><?php _e('Ranking', 'gnws'); ?></span>
        <div class="flex mt-2 justify-between max-sm:px-2">
            <div class="bg-white w-2/5 flex gap-1 text-black">
                <div
                    class="w-1/2 py-[10px] uppercase text-sm font-semibold text-center border-b-2 border-transparent duration-300 cursor-default hover:text-[#852121] hover:border-[#852121]">
                    <?php _e('women', 'gnws'); ?>
                </div>
                <div
                    class="w-1/2 py-[10px] uppercase text-sm font-semibold text-center text-[#852121] border-b-2 border-[#852121] duration-300 cursor-default hover:text-[#852121] hover:border-[#852121]">
                    <?php _e('men', 'gnws'); ?>
                </div>
            </div>
            <div class="w-2/5 flex gap-1 text-black">
                <div
                    class="w-1/2 py-[10px] uppercase text-sm font-semibold text-center bg-[#852121] text-white rounded-full duration-300 cursor-default hover:text-white hover:bg-[#852121]">
                    <?php _e('teams', 'gnws'); ?>
                </div>
                <div
                    class="w-1/2 py-[10px] uppercase text-sm font-semibold text-center bg-[#E4E4E7] rounded-full duration-300 cursor-default hover:text-white hover:bg-[#852121]">
                    <?php _e('Players', 'gnws'); ?>
                </div>
            </div>
        </div>
